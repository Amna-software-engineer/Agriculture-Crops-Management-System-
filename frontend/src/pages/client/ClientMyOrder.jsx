...
const ClientMyOrder = () => {
  ...
  const myPurchases = [
    {
      _id: "ORD-9921",
      time: "Oct 24, 2023",
      crop: { name: "Organic Wheat" },
      quantity: "500 kg",
      farmer: { name: "Zaid Khan" },
      totalPrice: "Rs. 25,000",
      status: "pending"
    },
    {
      _id: "ORD-9845",
      ...
      quantity: "1200 kg",
      farmer: { name: "Ali Raza" },
      totalPrice: "Rs. 48,000",
      status: "shipped"
    }
  ];
  ...
  {/* h-screen aur flex-col lagaya taake ye viewport ke mutabiq adjust ho */}
              ...
              {orderList.map((order) => (
                <tr key={order._id} className="bg-white hover:bg-gray-50/50 transition-all group">
                  <td className="px-6 py-5">
                    ...
                    {/* order.crop._id ab order._id ban chuka hai */}
                  </td>
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        {/* Pehla item dikhane ke liye order.items[0] use karein */}
