...
import EditCropModal from '../../component/former/EditCropModal';
...
const FormerCrops = () => {
  ...
  // Static data sirf design dikhane ke liye
  const crops = [
    { id: 1, name: "Organic Wheat", type: "Grain", qty: "500 kg", price: "Rs. 2500", status: "PENDING" },
    { id: 2, name: "Basmati Rice", type: "Grain", qty: "1200 kg", price: "Rs. 4000", status: "LIVE" },
    { id: 3, name: "Red Tomatoes", type: "Vegetable", qty: "300 kg", price: "Rs. 150", status: "LIVE" },
  ];
  ...
  return (
    <>
      <div className="p-6 bg-gray-50 min-h-screen">
        {/* Top Header */}
        <DashboardHeader page={"My Crops"} role={"Former"} />
        {/* Add button */}
        <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row justify-end items-center gap-4 my-7">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead className="bg-gray-50/50 text-gray-400 text-[11px] uppercase tracking-wider font-bold">
                <tr>
                  <th className="px-8 py-5">Crop Info</th>
                  <th className="px-8 py-5">Quantity / Price</th>
                ...
                {cropList && cropList.map((crop) => (
                  <tr key={crop?._id} className="hover:bg-gray-50/30 transition-all">
                    ...
                    <td className="px-8 py-6">
                      ...
                      <p className="text-gray-400 text-xs mt-0.5">{crop?.price}</p>
                    </td>
